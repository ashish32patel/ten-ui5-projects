sap.ui.require([
  ...
  var sViewName = "com.akp.pollutionTracker.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of com.akp.pollutionTracker"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.akp.pollutionTracker"
            });
        }
      }
